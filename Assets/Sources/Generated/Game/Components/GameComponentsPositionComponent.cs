...
public partial class GameEntity {
    ...
    public Components.PositionComponent componentsPosition { get { return (Components.PositionComponent)GetComponent(GameComponentsLookup.ComponentsPosition); } }
    public bool hasComponentsPosition { get { return HasComponent(GameComponentsLookup.ComponentsPosition); } }

    public void AddComponentsPosition(Data.Position newValue) {
    ...
    public void ReplaceComponentsPosition(Data.Position newValue) {
        var index = GameComponentsLookup.ComponentsPosition;
        var component = (Components.PositionComponent)CreateComponent(index, typeof(Components.PositionComponent));
        component.value = newValue;
